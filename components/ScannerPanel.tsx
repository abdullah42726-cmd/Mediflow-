...
// Added ScanLine to the imports
import { Camera, RefreshCw, CheckCircle2, AlertTriangle, ChevronDown, Save, Trash2, ScanLine } from 'lucide-react';
import { parsePrescription, checkInteractions } from '../services/geminiService';
import { ParsedItem, Medicine } from '../types';
import { MOCK_MEDICINES, SUCCESS_GREEN, WARNING_YELLOW, DANGER_RED } from '../constants';
